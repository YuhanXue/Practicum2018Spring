								...
								<form action="${pageContext.request.contextPath}/ModifyUserInfoServlet" method="post">
									...
									<table width="100%" border="0" cellspacing="2" class="upline">
										<tr>
											...
											<td style="width:40%; padding-left:20px">${u.id}</td>
											<td>&nbsp;</td>
										...
										<tr>
											...
											<td colspan="2">&nbsp;&nbsp;<input type="radio"
												name="gender" value="male" ${u.gender=='male'? "checked='checked'":""} /> male
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
												type="radio" name="gender" value="female" ${u.gender=='female'? "checked='checked'":""} />female</td>
										</tr>
										<tr>
