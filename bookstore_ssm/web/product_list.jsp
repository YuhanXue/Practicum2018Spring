							...
							<td>
									...
									<tr>
										<c:forEach items="${pb.products }" var="b">
											<td>
												...
												<div class="divlisttitle">
													<a href="${pageContext.request.contextPath }/findProductInfoServlet?id=${b.id}">书名:${b.name }<br />售价:${b.price } </a>
												</div>
											</td>
										</c:forEach>
									</tr>
								...
								<div class="pagination">
									<ul>
										...
										<li class="disablepage"><a href="${pageContext.request.contextPath  }/PageServlet?currentPage=${pb.currentPage==1?1:pb.currentPage-1}&category=${pb.getCategory()}">&lt;&lt;上一页</a></li>


										<li>第${pb.currentPage }页/共${pb.totalPage }页</li>

										<li class="nextPage"><a href="${pageContext.request.contextPath  }/PageServlet?currentPage=${pb.currentPage==pb.totalPage?pb.totalPage:pb.currentPage+1}&category=${pb.getCategory()}">&lt;&lt;下一页</a></li>
